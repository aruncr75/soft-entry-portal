  ...
  return (
    <div className="absolute" style={{ left: x, top: y }}>
      <div className="flex flex-col items-center">
        <div className="text-gray-600 mb-1">{id} - {ip}</div>
        <div className="relative flex flex-col items-center">
          ...
          {isHealthy ? (
            <CheckCircle className="text-green-500 absolute -right-3 -top-3" size={20} />
          ) : (
            <AlertCircle className="text-red-500 absolute -right-3 -top-3" size={20} />
          )}
        </div>
      </div>
    </div>
