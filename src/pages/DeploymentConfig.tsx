  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 bg-[#FFE7E0] p-8">
        <h1 className="text-3xl font-semibold mb-8">Deployment Configuration</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8 relative overflow-hidden min-h-[300px]">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <div className="w-6 h-6 bg-gray-200 flex items-center justify-center">
                <input 
                  ...
                  onChange={() => setSelectedDevice(selectedDevice === "point-to-point" ? "" : "point-to-point")}
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button variant="outline" className="border-[#111820] hover:bg-gray-100 px-10 rounded-md">
              Cancel
            </Button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 relative overflow-hidden min-h-[300px]">
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div>
              <label className="block text-gray-500 mb-2">SNMP timeout (Secs)</label>
              <Input 
                value={snmpTimeout}
            ...
            <div>
              <label className="block text-gray-500 mb-2">Nos. of retries</label>
              <Input 
                value={retries}
